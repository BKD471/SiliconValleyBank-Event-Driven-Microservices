...
public interface IValidationService {
    void validator(Loans loans, LoansDto loansDto, AllConstantsHelper.LoansValidateType loansValidateType,Optional<List<Loans>> listOptional) throws ValidationException, PaymentException, InstallmentsException, LoansException;
}
