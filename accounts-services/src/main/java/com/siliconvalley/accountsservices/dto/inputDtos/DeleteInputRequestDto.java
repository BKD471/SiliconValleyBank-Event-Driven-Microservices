...
public record DeleteInputRequestDto(String customerId,String name,int age,
                                    ...
                                    String panNumber,String voterId,String drivingLicense,String passportNumber,
                                    AllConstantHelpers.DeleteRequest deleteRequest,AllConstantHelpers.BenUpdateRequest benRequest,
                                    String beneficiaryId,String beneficiaryName,String beneficiaryAccountNumber,AllConstantHelpers.RELATION bloodRelation
                                    ...
                                    String beneficiaryEmail,String benVoterId,String benDrivingLicense,BigDecimal balance,AllConstantHelpers.UpdateRequest updateRequest,
                                    String branchCode,BigDecimal transferLimitPerDay,int creditScore,AllConstantHelpers.AccountStatus accountStatus,
                                    BigDecimal approvedLoanLimitBasedOnCreditScore,Boolean anyActiveLoans,BigDecimal totLoanIssuedSoFar,
                                    BigDecimal totalOutStandingAmountPayableToBank,String address,String imageName,List<Beneficiary> listOfBeneficiary,
                                    List<Transactions> listOfTransactions,Customer customer,List<Accounts> accountsList,Accounts accounts){
    public static final class Builder{
        ...
        public Builder deleteRequest(AllConstantHelpers.DeleteRequest deleteRequest){
        ...
        public Builder listOfBeneficiary(List<Beneficiary> listOfBeneficiary){
            this.listOfBeneficiary=listOfBeneficiary;
            return this;
        }

        public Builder listOfTransactions(List<Transactions> listOfTransactions){
        ...
        public Builder accountsList(List<Accounts> accountsList){
       ...
       public DeleteInputRequestDto build(){
            return new DeleteInputRequestDto(customerId,name,age,accountNumber,dateOfBirthInYYYYMMDD,accountType,homeBranch,
                    email,password,phoneNumber,adharNumber,panNumber,voterId,drivingLicense,passportNumber,
                    deleteRequest,benRequest,beneficiaryId,beneficiaryName,beneficiaryAccountNumber,bloodRelation,
                    ben_date_of_birthINYYYYMMDD,benAge,benBank,benAdharNumber,benPhoneNumber,benPanNumber,benPassportNumber,
                    beneficiaryEmail,benVoterId,benDrivingLicense,balance,updateRequest,branchCode,transferLimitPerDay,
                    creditScore,accountStatus,approvedLoanLimitBasedOnCreditScore,anyActiveLoans,totLoanIssuedSoFar,totalOutStandingAmountPayableToBank,
                    address,imageName,listOfBeneficiary,listOfTransactions,customer,accountsList,accounts);
       }
    }
}
