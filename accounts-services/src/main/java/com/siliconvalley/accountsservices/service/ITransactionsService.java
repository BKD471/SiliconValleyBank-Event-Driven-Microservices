...
public interface ITransactionsService {
    ...
    void getPastSixMonthsTransactionsForAnAccount(final String accountNumber, final BankStatementRequestDto.FORMAT_TYPE formatType) throws AccountsException, JRException, FileNotFoundException;
}
