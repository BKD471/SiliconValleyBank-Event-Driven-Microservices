...
//    private static final String PATH_TO_PROPERTIES = "accounts-services/src/test/java/com/siliconvalley/accountsservices/service/properties/AccountsServiceTests.properties";
//
...
//    }
//
//    AccountsServiceTests(@Qualifier("accountsServicePrimary") IAccountsService accountsService,
...
//
//        assertEquals("phoenix@gmail.com", response.customer().email(), "Customer Email should have matched");
//        assertEquals("passport", response.customer().passportNumber(), "Customer Passport should have matched");
//        assertEquals("address", response.customer().address(), "Customer address should have matched");
//        assertEquals("adhar", response.customer().adharNumber(), "Customer adhar should have matched");
//        assertEquals("voter", response.customer().voterId(), "Customer voter should have matched");
//        assertEquals("driving", response.customer().drivingLicense(), "Customer driving should have matched");
//        assertEquals("pan", response.customer().panNumber(), "Customer pan should have matched");
//        assertEquals(25, response.customer().age(), "Customer age should have matched");
//        assertEquals(LocalDate.of(1997, 12, 01), response.customer().DateOfBirth(),
//                "Customer dob should have matched");
//        assertEquals(60000, response.accounts().balance(), "Customer balance should have matched");
//        assertEquals(25000, response.accounts().transferLimitPerDay(), "Customer transferLimit should have matched");
//        assertEquals(750, response.accounts().creditScore(), "Customer credit score should have matched");
//    }
//
//    @Test
...
//        assertEquals(850, response.accounts().creditScore(), "Account CreditScore should have matched");
//        assertEquals(90000L, response.accounts().balance(), "Account Balance should have matched");
//        assertEquals(AllConstantHelpers.Branch.CHENNAI, response.accounts().homeBranch(), "Account Branch should have matched");
//    }
//
//    @Test
...
//
//        Set<Accounts> accountsList = new HashSet<>();
...
//        OutputDto response = accountsService.putRequestExecutor(putInputRequestDto);
//
//        assertEquals(AllConstantHelpers.Branch.BANGALORE, response.accounts().homeBranch(), "Accounts Branch should have matched");
//        assertEquals(newBranchCode, response.accounts().branchCode(), "Account Branch COde should have matched");
//    }
//
//    @Test
...
//        assertNotNull(response.customer(), "Customer should not be null");
//        assertEquals(response.customer().email(), request.getEmail(), "Customer Email should have updated");
//        assertEquals(response.customer().customerName(), request.getName(), "Customer Name should have updated");
//        assertEquals(response.customer().phoneNumber(), request.getPhoneNumber(), "Customer Phone Number should have updated");
//        assertEquals(response.customer().adharNumber(), request.getAdharNumber(), "Customer Adhar Number should have updated");
//        assertEquals(response.customer().panNumber(), request.getPanNumber(), "Customer Pan Number should have updated");
//        assertEquals(response.customer().voterId(), request.getVoterId(), "Customer Voter Id should have updated");
//        assertEquals(response.customer().address(), request.getAddress(), "Customer Address should have updated");
//        assertEquals(response.customer().drivingLicense(), request.getDrivingLicense(), "Customer DrivingLicense should have updated");
//    }
//
//    @Test
...
//        when(accountsRepositoryMock.save(any())).thenReturn(savedAccount);
//        OutputDto response = accountsService.putRequestExecutor(request);
//        assertEquals(125000L, response.accounts()
//                .transferLimitPerDay(), "Transfer limit should have updated");
//    }
//
//    @Test
